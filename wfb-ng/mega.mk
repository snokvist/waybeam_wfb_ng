...
# --- config-env applet (C; reads ../shared/wfb_json.h header-only parser) ---
$(MEGA_OBJ)/wfb_configenv.o: $(MULTICALL)/wfb_configenv.c $(MULTICALL)/wfb_configenv.h ../shared/wfb_json.h | $(MEGA_OBJ)
	$(MEGA_CC) -std=gnu99 -O2 -Wall $(MEGA_DEP) $(MEGA_DEFS) $(MEGA_CFLAGS) -I$(MULTICALL) $(SHARED_INC) -c -o $@ $<
